...
router.post(
  ...
  async (req, res) => {
    ...
    const { wallet, name, symbol, supply, fee, type, contractAddress, contentImageUrl, chains, trusted, mint} = req.body;
  ...
  async (req, res) => {
    ...
    try {
      ...
      if(contentImageUrl !== null) {
        ...
        contractContent.supply = supply;
        contractContent.fee = fee;
